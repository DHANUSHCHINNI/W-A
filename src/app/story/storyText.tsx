...
const storyTextSection5 = [
    ...
    <p key="2">
        <span className={styles.ptSerif}>But Amruta’s most radical training has been her own life.<br />
            With a lived reality of stammering, she has navigated a world that prizes fluency over authenticity, and has learned to challenge the invisibility of certain disabilities. Today, she’s not just a UK HCPC-licensed Drama and Movement Psychotherapist—she’s a researcher, a published author, and a powerful advocate for disability justice. Her work makes space for the parts of us that often go unseen.</span>
    </p>,
    <p key="3">
        <span className={styles.ptSerif}>Across 8+ years in the mental health field, Amruta has worked in India and the UK, walking alongside those living with trauma, addiction, and eating disorders. As part of Project Udaan—a pioneering mental health initiative between Tata Trusts and the Government of Maharashtra—Amruta led the integration of creative arts into psychiatric rehabilitation, transforming the Nagpur Regional Mental Hospital into a contemporary, arts-based therapeutic environment. Her work pioneered the use of arts as a rehabilitative tool for service users in a system that had long relied solely on conventional methods. She also contributed to the District Mental Health Programme, where she facilitated embodied practices and capacity-building for frontline workers as part of systemic mental health reform.</span>
    </p>,
    <p key="4">
        <span className={styles.ptSerif}>As co-founder of Well-being & Arts Hub, she designs bold, arts-led spaces that don’t just soothe—but provoke, stretch, and connect. She creates vibrant, arts-led spaces that challenge norms and invite people back to their bodies, their histories, and their wholeness. Her mission is not just to integrate Indian philosophies and classical arts into modern therapy—it’s to remind us that well-being doesn’t have to whisper. It can dance. It can roar.<br />
            If you’ve ever felt like your story didn’t fit the script, you’ll find something sacred in the way Amruta holds space: tender, true, and radically inclusive.</span>
    </p>
];
...
const storyTextSection6 = [
    ...
    <p key="2"> <span className={styles.ptSerif}>Over the past 10+ years, Kritija has led creative mental health interventions across India and the UK—from co-developing programs for at-risk youth in Tamil Nadu, to designing and delivering leadership training programmes for NHS staff in East London. She is a certified Queer Affirmative Counsellor and is passionate about workplace mental health policies.</span></p>,
    <p key="3"><span className={styles.ptSerif}>At Well-being & Arts Hub, she brings all of this experience into play—crafting transformational, arts-based spaces where individuals and organisations don’t just cope, they evolve. Her lens is always intersectional, her methods deeply embodied, and her mission clear: to disrupt the status quo, with care and creativity. Her politics are embodied. And her creativity is contagious.
        <br />
        For those who sit in the grey areas—between tradition and rebellion, vulnerability and strength—Kritija is not just a therapist. She is a builder of brave, beautiful new ground.</span>
    </p>
];
