...
export const fillingyourcupTextsection1 = (
    <div>
        <div className={`${styles.animatedHeading} ${styles.gradientBrownText}`} style={{ fontSize: '2.2rem', marginBottom: '3.5rem', animationDelay: '0.2s' }}>
            <span className={styles.highlight} style={{ fontSize: '2.2rem' }}></span> In fast-paced work environments, we often ask our people to pour from a cup that’s running dry.
        </div>
        <div className={styles.animatedHeading} style={{ fontSize: '1.7rem', marginBottom: '3.5rem', animationDelay: '0.2s' }}>
            Filling Your Cup is our signature arts-based workshop designed to offer space to pause, reflect, and refuel—so your teams can give their best without burning out.
        </div>
        <div className={styles.bodyText}>
            ...
            Thinking mental well-being, team morale, creative problem solving, team building experience within your industry context? Think Filling Your Cup.<br />
